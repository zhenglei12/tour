...
return [
    ...
    */
    ...
    'after_or_equal' => ':attribute必须是 :date 之后或相同的一个日期',
    'alpha' => ':attribute只能包含字母',
    'alpha_dash' => ':attribute只能包含字母、数字、中划线或下划线',
    'alpha_num' => ':attribute只能包含字母和数字',
    'array' => ':attribute必须是一个数组',
    'before' => ':attribute必须是 :date 之前的一个日期',
    'before_or_equal' => ':attribute必须是 :date 之前或相同的一个日期',
    'between' => [
        'numeric' => ':attribute必须在 :min 到 :max 之间',
        'file' => ':attribute必须在 :min 到 :max KB 之间',
    ...
    'required_unless' => ':attribute字段是必须的，除非 :other 是在 :values 中',
    ...
    */
    ...
    'attributes' => [
        ...
        "trip_info.*.meal" => "用餐安排",
        "trip_info.*.stay" => "住宿安排",
        "trip_info.*.content" => "行程内容",
        "order_staff.*.id_crad" => "人员身份证",
        "order_staff.*.phone" => "人员电话号码",
        "order_staff.*.type" => "类型",
        "order_staff.*.name" => "姓名",
        "order_staff.*.card_type" => "证件",
        "alias" => "中文名称",
        "permissions" => "权限",
        "day" => "日期",
        "email" => "邮箱",
